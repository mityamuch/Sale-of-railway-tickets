...
async def search_tickets_route(departure_station: str,
                               arrival_station: str, departure_date: datetime):
    try:
        return await TicketService.search_tickets(departure_station,
